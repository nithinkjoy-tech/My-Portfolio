    ...
    <div className='h-20 shadow-navbarShadow flex lg:h=[12vh] sticky top-0 z-60 bg-bodyColor px-8 pl-2 sm:pr-0 z-300 navbar w-[90%] mx-auto mt-5 border border-[rgba(76,78,79,0.7)] rounded-full custom-bg'>
      <Link href='/' className='w-[50%] flex items-center'>
        ...
        <div
            ...
            <a href="/docs/svelte-otp-input/basic-usage" target="_blank">
            ...
            <div className='hidden mdl:inline-flex itemscenter gap-7'>
                ...
                >
                    <button
                        className='border border-textGreen rounded-md text-textGreen text-[13px] px-6 py-3 hover:bg-hoverColor duration-200'>
                        Resume
                    </button>
                </a>
            </div>
            ...
            >
                <span
                    className='w-full h-[2px] bg-textGreen inline-flex transform translate-x-2 group-hover:translate-x-2 transition-all ease-in-out duration-300'></span>
                <span
                ...
                <span
                    className='w-full h-[2px] bg-textGreen inline-flex transform translate-x-1 group-hover:translate-x-3 transition-all ease-in-out duration-300'></span>
            </div>
            {showMenu && (
                <div
                ...
                >
                    <motion.div
                        ...
                        className='w-[100%] overflow-y-scroll scrollbarHide bg-bodyColor flex flex-col items-center px-4 py-10 relative bg-[var(--body-color)] rounded-t-[32px] border border-[#4b4b4b] !h-[88svh]'
                    >
                        <MdOutlineClose
